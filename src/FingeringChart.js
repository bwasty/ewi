  ...
  classes(roller) {
    ...
    if (this.props.rollerDiff > 0) {
      if (this.props.roller === roller)
        classes.push('diff-added')
      else if (this.props.roller === roller + 2)
        classes.push('diff-removed')
    }
    else if (this.props.rollerDiff < 0) {
      if (this.props.roller === roller + 1)
        classes.push('diff-added')
